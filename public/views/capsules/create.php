    ...
    <form id="capsule-form" method="POST" action="/capsules" class="card p-4">
            ...
            <div class="col-md-8">
                ...
                <div class="form-section mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Название поможет вам быстро найти капсулу</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="description" 
                                  ...
                                  rows="4"
                                  maxlength="1000"
                                  placeholder="Опишите назначение капсулы, стиль, особенности..."></textarea>
                    </div>
        ...
        <div class="form-actions mt-4">
            <button type="submit" class="btn btn-primary btn-lg">
                <i class="fas fa-save me-2"></i>Создать капсулу
            </button>
            <a href="/capsules" class="btn btn-outline-secondary btn-lg">
                Отмена
            </a>
        </div>
    </form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        // Проверка на наличие хотя бы одной вещи или образа
        const selectedItems = document.querySelectorAll('.item-checkbox:checked').length;
        const selectedOutfits = document.querySelectorAll('.outfit-checkbox:checked').length;

        if (selectedItems === 0 && selectedOutfits === 0) {
            alert('Выберите хотя бы одну вещь или образ для капсулы');
            return;
        }
        ...
        try {
            ...
            if (result.success) {
                window.location.href = result.data.redirect_url || '/capsules';
            } else {
                alert(result.message || 'Ошибка при создании капсулы');
            }
        } catch (error) {
